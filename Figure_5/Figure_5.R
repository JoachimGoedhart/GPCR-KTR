...
alln_baseline_avg <- alln_baseline_avg %>%
  mutate(bin_ERK = case_when(start_ERK >=0.15 & start_ERK <0.35  ~ "0.15-0.35",
                             start_ERK >=0.35 & start_ERK <0.60  ~ "0.35-0.60",
...
png(file=paste0("Figure_5.png"), width = 4000, height = 4800, units = "px", res = 400)
